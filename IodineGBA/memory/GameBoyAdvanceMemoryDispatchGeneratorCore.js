...
GameBoyAdvanceMemoryDispatchGenerator.prototype.generateMemoryReadIO8 = function () {
	...
	this.fillReadTableUnused(readIO, 0x10, 0x47);
	...
	this.fillReadTableUnused(readIO, 0x54, 0x5F);
	...
	this.fillReadTableUnused(readIO, 0xA0, 0xB9);
	...
	this.fillReadTableUnused(readIO, 0xBC, 0xC5);
	...
	this.fillReadTableUnused(readIO, 0xC8, 0xD1);
	...
	this.fillReadTableUnused(readIO, 0xD4, 0xDD);
	...
	this.fillReadTableUnused(readIO, 0xE0, 0xFF);
	...
	this.fillReadTableUnused(readIO, 0x110, 0x11F);
	...
	this.fillReadTableUnused(readIO, 0x12C, 0x12F);
	...
	this.fillReadTableUnused(readIO, 0x138, 0x13F);
	...
	this.fillReadTableUnused(readIO, 0x144, 0x14F);
	...
	this.fillReadTableUnused(readIO, 0x15C, 0x1FF);
	...
	this.fillReadTableUnused(readIO, 0x20C, 0x2FF);
...
GameBoyAdvanceMemoryDispatchGenerator.prototype.fillReadTableUnused = function (readIO, from, to) {
...
GameBoyAdvanceMemoryDispatchGenerator.prototype.generateMemoryWriteIO8 = function () {
	...
	//4000302h - NOT USED - ZERO
	writeIO[0x302] = this.memory.NOP;
	//4000303h - NOT USED - ZERO
	writeIO[0x303] = this.memory.NOP;
    //4000304h through 40003FFh - NOT USED - GLITCHED
	this.fillWriteTableNOP(writeIO, 0x304, 0x3FF);
    return writeIO;
}
GameBoyAdvanceMemoryDispatchGenerator.prototype.generateMemoryWriteIO16 = function () {
	...
	//4000302h - NOT USED - ZERO
	writeIO[0x302 >> 1] = this.memory.NOP;
    //4000304h through 40003FFh - NOT USED - GLITCHED
	this.fillWriteTableNOP(writeIO, 0x304 >> 1, 0x3FE >> 1);
    return writeIO;
}
