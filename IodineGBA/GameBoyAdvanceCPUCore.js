...
GameBoyAdvanceCPU.prototype.write32 = function (address, data) {
	...
	this.IOCore.memory.memoryWriteFast32((address & -4) >>> 0, data | 0);
...
GameBoyAdvanceCPU.prototype.write16 = function (address, data) {
    ...
    //Updating the address bus away from PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	this.IOCore.memory.memoryWriteFast16((address & -2) >>> 0, data | 0);
	//Updating the address bus back to PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
}
GameBoyAdvanceCPU.prototype.write8 = function (address, data) {
    ...
    //Updating the address bus away from PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	this.IOCore.memory.memoryWrite8(address >>> 0, data | 0);
	//Updating the address bus back to PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
}
GameBoyAdvanceCPU.prototype.read32 = function (address) {
    ...
    //Updating the address bus away from PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	var data = this.IOCore.memory.memoryReadFast32((address & -4) >>> 0) | 0;
...
GameBoyAdvanceCPU.prototype.read16 = function (address) {
    ...
    //Updating the address bus away from PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	var data = this.IOCore.memory.memoryReadFast16((address & -2) >>> 0) | 0;
	//Updating the address bus back to PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	return data | 0;
}
GameBoyAdvanceCPU.prototype.read8 = function (address) {
    ...
    //Updating the address bus away from PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	var data = this.IOCore.memory.memoryRead8(address >>> 0) | 0;
	//Updating the address bus back to PC fetch:
	this.IOCore.wait.NonSequentialBroadcast();
	return data | 0;
}