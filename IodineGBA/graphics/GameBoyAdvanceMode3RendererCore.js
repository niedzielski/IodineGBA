 ...
 *
 */
function GameBoyAdvanceMode3Renderer(gfx) {
	this.gfx = gfx;
}
GameBoyAdvanceMode3Renderer.prototype.renderScanLine = function (line) {
...
GameBoyAdvanceMode3Renderer.prototype.preprocess = function () {
	//Set up pixel fetcher ahead of time:
	this.gfx.bg2FrameBufferRenderer.selectMode(3);
}